...
def main():
    ...
    print(f"🔑 Clé Gemini: {GEMINI_API_KEY[:15]}...")
    
    if "NOUVELLE_CLE" in TELEGRAM_TOKEN or "NOUVELLE_CLE" in GEMINI_API_KEY:
        print("\n⚠️ ERREUR: Tu dois d'abord remplacer les clés !")
        print("Ligne 19: TELEGRAM_TOKEN")
        print("Ligne 20: GEMINI_API_KEY")
        return
